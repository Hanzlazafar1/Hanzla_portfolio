    ...
    >
      ...
      >
        ...
        {activeLocale === "en" && (
          <p>
            ...
            <span className="italic font-bold">Pushing the Boundaries of Creativity with Generative AI and Data Science.</span>.
          </p>
        )}
      </motion.h1>
      ...
      >
        ...
        <Link
          ...
          href="https://www.linkedin.com/in/hanzlazafar07/"
          target="_blank"
        >
          <BsLinkedin />
        </Link>
        ...
        <Link
          href="https://github.com/Hanzlazafar1"
